...
%  Function List :
%                   [] = DA_OUT(CH1_data,CH2_data,divFreq,dataNum,isGain,PC_IP,XSRP_IP)
%  Parameter List:       
%	Output Parameter
...
function [] = DA_OUT(CH1_data,CH2_data,divFreq,dataNum,isGain,PC_IP,XSRP_IP)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%创建配置UDP对象，并打开
udp_obj = udp(XSRP_IP,13345,'LocalHost',PC_IP,'LocalPort',12345,'TimeOut',100,'OutputBufferSize',61440,'InputBufferSize',61440*10);
fopen(udp_obj);
